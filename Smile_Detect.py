...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        for (ex, ey, ew, eh) in eyes:
            ...
            cv2.putText(roi_color, 'eye', (ex+25, ey-5), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (36,255,12), 2)
        ...
        for (xx, yy, ww, hh) in smile:
            ...
            cv2.putText(roi_color, 'mouth', (xx+25, yy-5), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (36,255,12), 2)
